...
assert.match(runsRoute, /withCalculatedEffort\(withoutWorkoutMetricStreams\(run\)\)/, 'history summaries omit large streams; owner-scoped detail still returns them');
