...
function acceptedFixture(db, owner, baseCandidateId) {
  ...
  const candidate = buildAdaptiveCoachingCandidate({ foundationInput: input, availability }).selected_candidate;
  ...
  const id = 'historical-accepted-candidate', assignment = 'historical-accepted-assignment';
