...
const ADAPTIVE_FOUNDATION_REASON_CODES = closed([
  'REST_MODALITY_UNAVAILABLE', 'REST_DATE_BLOCKED', 'REST_PROTECT_NEXT_KEY',
  'REST_AFTER_DEMANDING_WORK', 'REST_MEANINGFUL_DOSE_EXHAUSTED', 'REST_REQUIRED_RECOVERY_WINDOW',
