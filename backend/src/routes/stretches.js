...
const POOLS = {
  'hip-focused': [
    ...
    { id: 'butterfly', name: 'Butterfly Stretch', duration: 45, durationLabel: '45 sec', cue: 'Sit with the soles of your feet together and let your knees drop toward the floor. Hold your feet, sit tall, and gently press your knees down with your elbows.' },
    { id: 'figure-4', name: 'Figure-4 Stretch', duration: 30, durationLabel: '30 sec each side', cue: 'Lie on your back, cross one ankle over your opposite thigh, and pull the lower leg toward your chest. Press the crossed knee away to deepen the stretch.' },
    ...
    { id: 'sumo-squat-hold', name: 'Sumo Squat Hold', duration: 45, durationLabel: '45 sec', cue: 'Stand with feet wider than shoulder-width and toes turned out. Squat down and use your elbows to gently press your knees open, stretching the inner hips.' },
  ...
  'lower-back': [
    ...
    { id: 'hip-flexor-back', name: 'Hip Flexor Release', duration: 30, durationLabel: '30 sec each side', cue: 'Kneel in a lunge with your back knee down. Tuck your pelvis and hold. Tight hip flexors pull on the lumbar spine — releasing them relieves back tension.' },
  ],
};
