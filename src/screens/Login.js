      ...
      <View className="flex-1 justify-center gap-5">
        <View className="gap-3">
          <View className="h-12 w-12 items-center justify-center rounded-xl bg-forge-card border border-forge-border">
            <Shield color="#EAB308" size={22} />
          </View>
          <Text className="text-3xl font-bold text-forge-text">FORGE</Text>
          <Text className="text-base text-forge-subtext">Sign in to continue training.</Text>
        </View>
        ...
        >
          <Text className="font-semibold text-black">{loading ? 'Signing In...' : 'Sign In'}</Text>
        ...
        <Pressable onPress={() => navigation.navigate('Register')} className="py-2">
          <Text className="text-center text-forge-subtext">
            No account? <Text className="text-forge-accent">Create one</Text>
          </Text>
        </Pressable>
      </View>
    </KeyboardAvoidingView>
