...
import { Trophy, Users, Flag, Package } from 'lucide-react'
...
const NAV_ITEMS = [
  ...
  { to: '/races', label: 'Races', iconComponent: Flag, color: '#EAB308' },
  { to: '/gear', label: 'Gear', iconComponent: Package, color: '#EAB308' },
