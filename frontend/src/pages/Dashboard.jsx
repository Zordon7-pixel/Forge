...
import { Award, CalendarClock, Flame, Footprints, Minus, Share2, TrendingDown, TrendingUp, Trophy, X } from 'lucide-react'
...
function YouVsLastMonthCard({ comparison }) {
...
function EngagementHighlights({ engagement, navigate }) {
...
export default function Dashboard() {
  ...
  const fetchDashboardData = useCallback(async () => {
    try {
        const [statsRes, runsRes, liftsRes, warningRes, checkinRes, goalRes, complianceRes, loadRes, nextRaceRes, gearRes, injuryRes, recapRes, recommendationRes, ageGradedRes, executionRes, groupRunsRes, adaptationRes, hybridScoreRes, hybridStreakRes, engagementRes] = await Promise.all([
          ...
          api.get('/stats/engagement').catch(() => ({ data: null })),
        ])
  ...
  return (
    <div className="space-y-4">
      ...
      <EngagementHighlights engagement={engagement} navigate={navigate} />
