...
assert.ok(studio.indexOf("setStatus('In the share sheet") < studio.indexOf("await navigator.share({ title: 'Save Forged Hybrid share card'"), 'the Save Image instruction is set before the old-shell share sheet opens')
...
console.log('PHOTO LIBRARY SAVE SMOKE OK (15)')
