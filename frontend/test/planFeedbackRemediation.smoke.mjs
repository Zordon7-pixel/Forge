...
console.log('\n== Rest-day actions ==')
assert(insights.includes("const isRestDay = execution?.isPlannedRest === true || execution?.restSource === 'planned'"), 'Today suppresses check-in only for an explicitly scheduled plan rest day')
