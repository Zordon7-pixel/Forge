...
| 2026-08-15 | codex | Patched Apple Watch full-fidelity workout import and run-recap timelines for route/elevation, heart rate/recovery, pace, power, cadence, stride length, vertical oscillation, and ground-contact time; schema v6 awaits Railway deploy, a separately approved EAS build, and physical-iPhone verification | uncommitted |
