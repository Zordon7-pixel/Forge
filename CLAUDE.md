...
| 2026-07-15 | codex + claude-code + hermes | Built and QA-approved Phase 4A invite-only mutual friends, one-use hashed invites, block/report safety, account-data coverage, and the mobile Community surface; Railway live verification remains the release gate and no EAS build was run | `e656c00f` |
| 2026-07-15 | codex + claude-code + hermes | Built and QA-approved Phase 4A.1 opt-in exact-handle friend discovery, uniform unavailable responses, per-user rate limits, block-aware mutual requests, hidden-by-default accounts, and secondary invite links; Railway live verification remains the release gate and no EAS build was run | `54f8c73e` |
