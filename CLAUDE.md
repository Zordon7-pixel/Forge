...
| 2026-07-17 | codex | Added the missing HealthKit update purpose string to Expo and native metadata plus a fail-before-build privacy verifier; build 18 awaits explicit EAS approval | pending commit |
